...
for(i in 1:N) {
  H0[i,] <- AR(size = M, phi = 0, omega = 0, alpha = runif(1, 0.85, 0.99), beta = 0, st = FALSE, inov = 1)
  H1[i,] <- AR(size = M, phi = runif(1, 0.01, 0.15), omega = 0, alpha = runif(1, 0.85, 0.99), beta = 0, st = FALSE, inov = 1)
}
